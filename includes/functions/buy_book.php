...
//    echo("<center><h1><a href='./pdf/invoice.php'>Download computer generated bill </a></h2></center>");
     ...
     $subject = "Hi!";
    $body = "
    sellers name=>".$seller."                     buyers name=> ". $buyername."		Buyer email-id=>".$_SESSION['email_id']."                        book id =>".$bid." A book have been sold.please check the database 'book_invoice' for further details.\nCheck Book deatils from http://books.engineerinme.com/enalarge.php?bid=".$bid;
